...
try:
    from PyQt4.QtGui import QApplication,QImage,QPainter # type: ignore
    from PyQt4.QtCore import QUrl # type: ignore
    from PyQt4.QtWebKit import QWebPage # type: ignore
    hasPyQt4=True
except ImportError:
    hasPyQt4=False
...
class _WfBrowser:
    ...
    def __init__(self,pool=None):
        if not hasPyQt4:
            raise ImportError("PyQt4 library not found")
        self.pool=pool
        self.app=None
        self._busy=False
        self.callback=None
    ...
    def _poolThread(self):
        while True:
            ...
            self.pool._queue.task_done() # pylint: disable=protected-access
