"""
Bundle of a website and its assets
"""
from paths import Url,UrlCompatible

class WebsiteAsset:
    """
    A single asset that is a part of a website
    """
...
class Website:
    ...
    """
    def __init__(self,url:UrlCompatible,websitesObject=None):
    ...
    def get(self,date=None,fetchIfMissing=False,addIfFetched=False):
        ...
        if self._websitesObject:
            return self._websitesObject.get(
                self,date,fetchIfMissing,addIfFetched)
        else:
