...
class MediaFinder:
    ...
    def thenFind(self,
        ...
        glob:bool=True,
        re:bool=False,
        timeFormatted:bool=True):
        """
        Add the next thing to look for.

        If glob=True, you can do '*'s like "http://foo.com/*.mp3"
        If re=True, you can do regular expressions like
            "http://foo.com/[0-9]{1,6}.mp3"
        If timeFormatted=True, you can use strftime()
