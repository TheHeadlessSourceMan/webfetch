...
def __youtubeFetch(
    ...
    def gotVideoPage(url,data):
        """
        Called when the video page is gotten
        ...
        data=data[-1]
        flashvars={}
        for d in data.split('flashvars="',1)[-1]\
            .split('"',1)[0]\
            .split('&amp;'):
            #
            d=d.split('=',1)
            flashvars[d[0]]=d[-1]
        video_id=urldecode(flashvars['video_id'])
        t=urldecode(flashvars['t'])
        downloadUrl='http://www.youtube.com/get_video?video_id='+video_id+'&t='+t # noqa: E501 # pylint: disable=line-too-long
        wf.enqueue(gotThumbnail,video_id,title)
...
def _cheaterDownload2(video_id):
    ...
    try:
        ...
        print('***************************************')
        print('  NEED TO INSTALL YOUTUBE DOWNLOADER!')
        cmd='wget -O Sources.zip http://py-youtube-downloader.googlecode.com/files/Sources.zip;unzip -q Sources.zip;rm -rf Sources.zip py2exe' # noqa: E501 # pylint: disable=line-too-long
        os.system(cmd)
...
def cmdline(args):
    ...
    if printHelp:
        ...
        print('OPTIONS:')
        print('   -h ............................................................... print help') # noqa: E501 # pylint: disable=line-too-long
        print('   --format ........................................... the video format to save') # noqa: E501 # pylint: disable=line-too-long
        print('   --outDir ............................................... the output directory') # noqa: E501 # pylint: disable=line-too-long
    else:
