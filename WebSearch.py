...
class WebSearch:
    ...
    def _url2soup(self,url:UrlCompatible)->typing.Any:
        ...
        try:
            if urllib2 is None:
                ...
                headers={
                    'User-Agent':'Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1)'} # noqa: E501 # pylint: disable=line-too-long
    ...
    def _googleTranslate(self,
        ...
        """
        tool to access google translate
        """
        ...
        try:
            return [
                urllib.parse.unquote_plus(
                    urlRe.findall(h3.find('a')['href'])[0])
...
if __name__ == '__main__':
    ...
    if len(sys.argv)<2:
        ...
        search=WebSearch()
        print('Search: '+searchString+'\n\t'+'\n\t'.join(search.search(searchString))) # noqa: E501 # pylint: disable=line-too-long
